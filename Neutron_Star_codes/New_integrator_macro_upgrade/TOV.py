...
#Output data
    ...
    def Compute(self):
        ...
        if sol.t[-1]<self.radiusMax_in:
            ...
            # else:
            #     self.hbar_star_retro = (self.phiStar)**(-1/2)
            ######################
            self.hbar_star = (self.phiStar)**(-1/2)
...
# ############################################################################
#
#     #Ploting hbar versus the radius ER.
#     def Plot(self):
...
#         # plt.show()
#
#     #Recording hbar_star data in a specific folder
#     def hbar_star_txt(self):
#         folder_path = './hbar_star_folder'
#         if not os.path.exists(folder_path):
#             os.makedirs(folder_path)
#         Name = "./hbar_star_folder/hbar_star_data.txt"
#         if not os.path.exists(Name):
#             open(Name, 'w').close()
#         with open(Name, 'w') as f:
#             #for element in self.hbar_star:
#             f.write(str(self.hbar_star) + '\n')
#
#
#     #Recording hbar_retro data in a specific folder
#     def hbar_star_retro_txt(self):
#         folder_path = './hbar_star_folder'
#         if not os.path.exists(folder_path):
#             os.makedirs(folder_path)
#         Name = "./hbar_star_folder/hbar_star_retro_data.txt"
#         if not os.path.exists(Name):
#             open(Name, 'w').close()
#         with open(Name, 'w') as f:
#             #for element in self.hbar:
#             f.write(str(self.hbar_star_retro) + '\n')


    # def hbar_dependence(self):
    #     hbar_inf = 1/self.phi_inf
    #     dependence = self.dependence
    #     HBAR_star = []
    #     file_path = ('./hbar_star_folder/hbar_star_data.txt')
    #     f = open(file_path, 'r')
    #     for x in f:
    #         HBAR_star.append(x)
    #     for i in range(len(HBAR_star)):
    #         HBAR_star[i] = float(HBAR_star[i])
    #
    #     HBAR_star_retro = []
    #     file_path = ('./hbar_star_folder/hbar_star_retro_data.txt')
    #     f = open(file_path, 'r')
    #     for x in f:
    #         HBAR_star_retro.append(x)
    #     for i in range(len(HBAR_star_retro)):
    #         HBAR_star_retro[i] = float(HBAR_star_retro[i])
    #
    #     HBAR_center = []
    #     file_path = ('./hbar_folder/hbar_data.txt')
    #     f = open(file_path, 'r')
    #     for x in f:
    #         HBAR_center.append(x)
    #     for i in range(len(HBAR_center)):
    #         HBAR_center[i] = float(HBAR_center[i])
    #
    #     HBAR_center_retro = []
    #     file_path = ('./hbar_folder/hbar_retro_data.txt')
    #     f = open(file_path, 'r')
    #     for x in f:
    #         HBAR_center_retro.append(x)
    #     for i in range(len(HBAR_center_retro)):
    #         HBAR_center_retro[i] = float(HBAR_center_retro[i])
    #
    #     key = f'hbar_error_{dependence}'
    #     value = ((((HBAR_star_retro[0]) - (HBAR_star[0]))/(HBAR_star_retro[0]-hbar_inf)) * 100)
    #     value = f"{value:.0f}"
    #     dict_var = {}
    ...
    #
    #     key = f'hbar_center_error_{dependence}'
    #     value = ((((HBAR_center_retro[0] ) - (HBAR_center[0] ))/(HBAR_center_retro[0]-hbar_inf)) * 100)
    #     value = f"{value:.0f}"
    #     dict_var = {}
    #     file_path = os.path.join(os.getcwd(), "NS_hbar_dependency_data.dat")
    #     dict_var[key] = value
